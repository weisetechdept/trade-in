        ...
        var count = new Vue({
            ...
            methods: {
                searchData() {
                    ...
                    $('#datatable').DataTable().ajax.url('/admin/system/home.api.php?get=search&start='+this.search.start+'&end='+this.search.end+'&status='+this.search.status+'&team=all').load(function() {
